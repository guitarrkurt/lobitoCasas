...
<html>
  <head>
    ...
    <title>Unirenta - Acerca de</title>
    ...
    <nav class="navbar navbar-inverse navbar-static-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php?page=1>Unirenta</a>
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="" onClick="window.location.reload()">Acerca de</a></li>
    ...
    <div class="container">
      <div class="row">      
        <div class="col-md-12">
          <div id="content">
		    <p>
		 Somos una pagina la cual te facilita la informacion de los hs pedajes cercanos a tu 
		 facultad, para los estudiantes.
			</p>
          </div>
