  ...
  <body>
	...
	<div class="collapse navbar-collapse">
		  ...
		  <li><a href="#">Busqueda por</a></li>
			<ul>
				 ...
				 <li><a class="active" href="costo.php?page=1">Costo Extras</a></li> 
    ...
    <div class="container">
      <div class="row">
		...
		$content=mysql_query("SELECT * FROM hospedajes order by  costosExtras limit $start,$end ");
